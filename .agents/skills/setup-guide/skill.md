...
3. **Learn the workflow:** See the Workflow skill or run `/workflow` in Codex
...
For command reference: See the CLI Reference skill or run `/cum` in Codex.
For workflow guide: See the Workflow skill or run `/workflow` in Codex.
