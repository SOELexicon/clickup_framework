...
def _get_fallback_commands():
    ...
    return {
        "📊 View Commands": [
            ...
            ("task_types [tt]", "[list_id]", "Display all task types (custom items) with their numeric IDs"),
        ...
        "⏱️  Time Tracking": [
            ("time", "start|stop|status|list|add|delete [options]", "Manage running timers and manual time entries"),
        ],
        "📦 Export/Dump": [
        ...
        "📊 Diagram Management": [
            ("map", "[--python|--csharp|--all-langs] [--mer TYPE] [OPTIONS]", "Generate code maps and Mermaid diagrams from source"),
            ("mermaid", "<input_file> [--output OUTPUT] [OPTIONS]", "Process markdown files and render Mermaid diagrams"),
            ("diagram-diff", "<baseline_file> <current_file> [OPTIONS]", "Compare two Mermaid diagrams and summarize changes"),
        ],
        "🛠️  Utility Commands": [
            ("diff", "<file1> <file2> | --old TEXT --new TEXT [OPTIONS]", "Compare two files or strings and show unified diff"),
            ("stalker", "[path] [--browse] [--dry-run] [OPTIONS]", "Launch the ProcMon-backed file system stalker in a new console"),
        ],
        "🎨 Configuration": [
...
def _display_examples_and_footer(use_color):
    ...
    examples = [
        ...
        ("cum time status", "Show the currently running ClickUp timer"),
        ...
        ("cum tt", "List all workspace task types and their IDs"),
        ("cum stalker . --dry-run", "Preview the ProcMon stalker launch command"),
