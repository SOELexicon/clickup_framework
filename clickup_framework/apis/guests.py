...
class GuestsAPI(BaseAPI):
    ...
    def add_guest_to_task(
        ...
        Args:
            ...
            permission_level: Required by ClickUp's API -- one of
                'read', 'comment', 'edit', or 'create'. Sent as the JSON
                body, not a query param.
            **params: Optional query params (e.g. include_shared)
        """
        return self._request(
            "POST",
            f"task/{task_id}/guest/{guest_id}",
    ...
    def add_guest_to_list(
        ...
        """
        return self._request(
            "POST", f"list/{list_id}/guest/{guest_id}", json={"permission_level": permission_level}
        )
    ...
    def add_guest_to_folder(
        ...
        return self._request(
            "POST",
            f"folder/{folder_id}/guest/{guest_id}",
            json={"permission_level": permission_level},
        )
