"""
Example command using BaseCommand.

This file demonstrates how to refactor an existing command to use the BaseCommand
base class. This is a reference implementation showing best practices.
"""
...
class ClearCurrentCommand(BaseCommand):
    """
    Clear current context command using BaseCommand.
    
    This is an example refactored version of clear_current_command showing
